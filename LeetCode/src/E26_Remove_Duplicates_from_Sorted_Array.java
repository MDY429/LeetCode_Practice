...
public class E26_Remove_Duplicates_from_Sorted_Array {
    ...
    public static void main(String[] args) {
        E26_Remove_Duplicates_from_Sorted_Array e26 = new E26_Remove_Duplicates_from_Sorted_Array();
        int[] nums = new int[] { 0, 0, 1, 2, 3, 3, 4, 4, 5, 5 };

        int len = e26.removeDuplicates(nums);
        for (int i = 0; i < len; i++) {
            System.out.print(i + " ");
        }
    }
